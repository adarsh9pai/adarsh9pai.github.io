...
const Contact = () =>{
    return(
        ...
        {links}
        <br/>
        <strong style = {{color : 'white'}}>or email me at <a href = "mailto:adarsh9pai@gmail.com" style = {{color : "#ffff00"}}>adarsh9pai@gmail.com</a></strong><br/><br/> 
        <strong style = {{color : '#ffff00'}}>PGP Public Key</strong><br/><br/>
